...
@section('title', 'Tanami - Detail User')
@section('header_title', 'Detail User')
...
<div class="max-w-[1400px] mx-auto space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div class="space-y-1">
            ...
            <h2 class="text-2xl font-heading font-extrabold text-tanami-dark">Detail User</h2>
        </div>
            ...
            <div class="bg-white rounded-2xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-gray-50 p-6 sticky top-6">
                <div class="flex flex-col items-center text-center pb-6 border-b border-gray-50">
                    ...
                    <div class="flex items-center gap-2 flex-wrap justify-center">
                        ...
                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-orange-50 text-orange-700 uppercase tracking-wide border border-orange-100">
                            <span class="material-symbols-outlined text-sm">shopping_cart</span> Buyer
                        </span>
                        @else
                ...
                <div class="pt-6 space-y-5">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-0.5">Phone Number</p>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-0.5">Join Date</p>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-0.5">Address</p>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="bg-white rounded-xl p-5 border border-gray-100 shadow-sm">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Total Spent</p>
                ...
                <div class="bg-white rounded-xl p-5 border border-gray-100 shadow-sm">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Total Products</p>
            ...
            <div class="bg-white rounded-2xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-gray-50 overflow-hidden">
                <div class="p-6 border-b border-gray-50">
                    ...
                    <p class="text-xs text-gray-400 font-medium mt-1">10 recent orders from this buyer</p>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-gray-50 overflow-hidden">
                <div class="p-6 border-b border-gray-50">
                    <h3 class="text-lg font-heading font-bold text-tanami-dark">Products</h3>
                    <p class="text-xs text-gray-400 font-medium mt-1">10 products from this farmer</p>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        <thead>
                        ...
                        <tbody class="text-sm divide-y divide-gray-50">
                            ...
                            <tr class="hover:bg-gray-50/30 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    @if($produk->is_active)
                                    <span class="inline-flex px-2.5 py-1 rounded-full text-[10px] font-bold bg-green-50 text-green-700 uppercase tracking-wide">Active</span>
                                    @else
            ...
            <div class="bg-white rounded-2xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-gray-50 overflow-hidden">
                <div class="p-6 border-b border-gray-50">
                    <h3 class="text-lg font-heading font-bold text-tanami-dark">Bank Account</h3>
                    <p class="text-xs text-gray-400 font-medium mt-1">Bank account list of farmer</p>
                </div>
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="border border-gray-100 rounded-xl p-4 {{ $rek->is_utama ? 'bg-green-50/50 border-green-200' : 'bg-gray-50' }}">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            @if($rek->is_utama)
                            <span class="text-[10px] font-bold text-green-700 bg-green-100 px-2 py-0.5 rounded-full uppercase">Primary</span>
                            @endif
                        </div>
            ...
            <div class="bg-white rounded-2xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-gray-50 p-12 text-center">
                ...
                <p class="text-gray-700 font-semibold">No activity found</p>
                <p class="text-gray-500 text-sm mt-1">This user has no activity data.</p>
            </div>
            @endif
