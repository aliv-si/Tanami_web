...
@section('content')
    <div class="max-w-[1400px] mx-auto space-y-8">
        ...
        <div class="flex items-center gap-2 text-xs font-medium text-gray-400 mb-1">
            ...
            <span class="material-symbols-outlined text-[10px]">chevron_right</span>
            <span class="text-primary">Verifikasi Petani</span>
        </div>

        {{-- Header --}}
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                <h1 class="text-2xl font-heading font-bold text-[#1e3f1b]">Verifikasi Petani</h1>
                <p class="text-gray-500 text-sm mt-1">Daftar petani yang menunggu verifikasi akun</p>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-gray-50/50 text-xs text-gray-500 font-bold uppercase border-b border-gray-200 font-heading tracking-wider">
                            ...
                            <th class="py-4 px-4">Petani</th>
                            <th class="py-4 px-4">Email</th>
                            <th class="py-4 px-4">No. HP</th>
                            <th class="py-4 px-4">Alamat</th>
                            <th class="py-4 px-4">Tgl Daftar</th>
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-gray-700 font-semibold">Semua petani sudah terverifikasi!</p>
                                        <p class="text-gray-500 text-sm mt-1">Tidak ada akun petani yang menunggu verifikasi.</p>
                                    </div>
                                </div>
                            </td>
                        </tr>
