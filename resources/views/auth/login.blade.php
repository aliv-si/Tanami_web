                ...
                <div class="p-6 sm:p-8">
                    ...
                    <form action="{{ route('login') }}" class="space-y-4" method="POST">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="relative">
                                <input
                                    class="w-full px-3 py-2.5 rounded-lg border border-gray-200 focus:border-[#53be20] focus:ring-1 focus:ring-[#53be20] outline-none transition-all font-sans text-sm text-gray-800 placeholder-gray-400 @error('email') border-red-500 @enderror"
