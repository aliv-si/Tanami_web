...
<div class="flex flex-col h-full">
    ...
    <div class="bg-white border-b border-gray-100 px-8 py-6 flex-shrink-0 z-10">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">

            {{-- Bagian Kanan: Tombol Aksi (Verifikasi Petani & Add User) --}}
        </div>

        {{-- Toolbar Bawah Header: Search & Filter --}}
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="text-sm divide-y divide-gray-50">
                            ...
                            <tr class="hover:bg-gray-50/30 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="{{ route('admin.pengguna.show', 1) }}" class="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                            ...
                            <tr class="hover:bg-gray-50/30 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="{{ route('admin.pengguna.show', 2) }}" class="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                                            <span class="material-symbols-outlined text-[20px]">visibility</span>
                                        </a>
                                        <button class="p-1.5 text-gray-400 hover:text-primary hover:bg-green-50 rounded-lg transition-colors">
                                            <span class="material-symbols-outlined text-[20px]">edit</span>
                            ...
                            <tr class="hover:bg-gray-50/30 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="{{ route('admin.pengguna.show', 3) }}" class="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                                            <span class="material-symbols-outlined text-[20px]">visibility</span>
                                        </a>
                                        <button class="p-1.5 text-gray-400 hover:text-primary hover:bg-green-50 rounded-lg transition-colors">
                                            <span class="material-symbols-outlined text-[20px]">edit</span>
                            ...
                            <tr class="hover:bg-gray-50/30 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="{{ route('admin.pengguna.show', 4) }}" class="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                                            <span class="material-symbols-outlined text-[20px]">visibility</span>
                                        </a>
                                        <button class="p-1.5 text-gray-400 hover:text-primary hover:bg-green-50 rounded-lg transition-colors">
                                            <span class="material-symbols-outlined text-[20px]">edit</span>
