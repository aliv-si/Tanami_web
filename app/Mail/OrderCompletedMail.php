...
class OrderCompletedMail extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        $subject = $this->recipientType === 'pembeli'
            ? 'Pesanan Selesai! 🎉 Terima kasih telah berbelanja - #' . $this->pesanan->id_pesanan
            : 'Pesanan Selesai! 💰 Dana sudah dikirim - #' . $this->pesanan->id_pesanan;
    ...
    public function content(): Content
    {
        return new Content(
            ...
            with: [
                ...
                'reviewUrl' => url('/pembeli/pesanan/' . $this->pesanan->id_pesanan . '/ulasan'),
            ],
        );
    }
