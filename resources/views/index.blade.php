...
<body
    class="bg-background-light dark:bg-background-dark font-display text-[#101b0d] dark:text-[#f9fcf8] min-h-screen flex flex-col overflow-x-hidden">
    <!-- Top Navigation Bar -->
    <header
        class="sticky top-0 z-50 w-full bg-surface-light/95 dark:bg-surface-dark/95 backdrop-blur-md border-b border-[#e9f3e7] dark:border-[#2a3f25]">
        <div class="px-4 md:px-10 lg:px-40 py-3 flex items-center justify-between gap-4">
            ...
            <div class="hidden md:flex flex-1 max-w-xl mx-8">
                <div
                    class="flex w-full items-center rounded-lg bg-[#e9f3e7] dark:bg-[#2a3f25] h-10 px-3 transition-colors focus-within:ring-2 focus-within:ring-primary/50">
                    <span class="material-symbols-outlined text-[#599a4c] dark:text-[#8abe7f]">search</span>
                    <input
                        class="w-full bg-transparent border-none focus:ring-0 text-sm ml-2 placeholder-[#599a4c] dark:placeholder-[#8abe7f] text-[#101b0d] dark:text-white"
                        placeholder="Cari sayur, buah, atau alat tani..." type="text" />
                </div>
            </div>
            <!-- Right Actions -->
            <div class="flex items-center gap-3 md:gap-6">
                ...
                <div class="flex items-center gap-2">
                    <button
                        class="flex items-center justify-center size-10 rounded-lg bg-[#e9f3e7] dark:bg-[#2a3f25] hover:bg-primary/20 dark:hover:bg-primary/20 transition-colors text-[#101b0d] dark:text-white">
                    ...
                    <button
                        class="hidden sm:flex h-10 px-5 items-center justify-center rounded-lg bg-primary hover:bg-primary/90 text-[#101b0d] text-sm font-bold tracking-wide transition-colors">
                        Masuk
                    </button>
                </div>
            </div>
        ...
        <div class="md:hidden px-4 pb-3">
            <div class="flex w-full items-center rounded-lg bg-[#e9f3e7] dark:bg-[#2a3f25] h-10 px-3">
                ...
                <input
                    class="w-full bg-transparent border-none focus:ring-0 text-sm ml-2 placeholder-[#599a4c] text-[#101b0d] dark:text-white"
    ...
    <main class="flex-1 w-full max-w-[1440px] mx-auto flex flex-col">
        ...
        <div class="px-4 md:px-10 lg:px-40 py-6">
            <div class="@container">
                <div class="flex min-h-[400px] md:min-h-[480px] flex-col gap-6 rounded-xl bg-cover bg-center bg-no-repeat items-start justify-end px-6 pb-10 md:px-12 md:pb-16 shadow-lg overflow-hidden relative group"
                    data-alt="Fresh vegetables and fruits arranged aesthetically on a wooden table in a farm setting"
                    ...
                    <div class="flex flex-col gap-3 text-left max-w-2xl relative z-10">
                        <span
                            class="inline-block px-3 py-1 bg-primary text-[#101b0d] text-xs font-bold rounded-full w-fit mb-2">PROMO
                            MINGGU INI</span>
                        <h1
                            class="text-white text-3xl md:text-5xl font-black leading-tight tracking-tight drop-shadow-sm">
                            Segar Langsung dari Ladang ke Meja Anda
                        </h1>
                        <h2
                            class="text-gray-100 text-sm md:text-lg font-medium leading-relaxed max-w-lg drop-shadow-sm">
                            Dapatkan hasil panen terbaik dengan jaminan kesegaran dan harga tangan pertama dari petani
                            lokal.
                        </h2>
                    </div>
                    <div class="relative z-10 pt-2">
                        <button
                            class="flex h-12 px-6 cursor-pointer items-center justify-center rounded-lg bg-primary hover:bg-[#32d611] text-[#101b0d] text-base font-bold transition-all transform hover:scale-105 shadow-lg shadow-green-900/20">
                            Belanja Sekarang
                        </button>
                    </div>
                </div>
        ...
        <div class="px-4 md:px-10 lg:px-40 py-2">
            <div
                class="grid grid-cols-2 md:grid-cols-4 gap-4 p-6 bg-surface-light dark:bg-surface-dark rounded-xl shadow-sm border border-[#e9f3e7] dark:border-[#2a3f25]">
        ...
        <section class="px-4 md:px-10 lg:px-40 py-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                <!-- Category Item 1 -->
                <a class="group flex flex-col items-center gap-3 p-4 bg-surface-light dark:bg-surface-dark rounded-xl border border-transparent hover:border-primary/30 hover:shadow-md transition-all"
                    href="#">
                    <div class="w-20 h-20 rounded-full bg-cover bg-center shadow-sm group-hover:scale-105 transition-transform"
                        data-alt="Close up of fresh green vegetables"
                ...
                <a class="group flex flex-col items-center gap-3 p-4 bg-surface-light dark:bg-surface-dark rounded-xl border border-transparent hover:border-primary/30 hover:shadow-md transition-all"
                    href="#">
                    <div class="w-20 h-20 rounded-full bg-cover bg-center shadow-sm group-hover:scale-105 transition-transform"
                        data-alt="Various fresh colorful fruits"
                ...
                <a class="group flex flex-col items-center gap-3 p-4 bg-surface-light dark:bg-surface-dark rounded-xl border border-transparent hover:border-primary/30 hover:shadow-md transition-all"
                    href="#">
                    <div class="w-20 h-20 rounded-full bg-cover bg-center shadow-sm group-hover:scale-105 transition-transform bg-gray-100 flex items-center justify-center text-primary"
                        data-alt="Abstract pattern for more categories">
        ...
        <!-- Flash Sale Section -->
        <section
            class="px-4 md:px-10 lg:px-40 py-8 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
                <!-- Product Card 1 -->
                <div
                    class="bg-surface-light dark:bg-surface-dark rounded-lg overflow-hidden border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow group flex flex-col">
                    ...
                    <div class="p-3 flex flex-col flex-1">
                        ...
                        <div class="mt-auto">
                            ...
                            <button
                                class="w-full h-9 rounded bg-primary hover:bg-[#32d611] text-[#101b0d] text-sm font-bold flex items-center justify-center gap-2 transition-colors">
                ...
                <div
                    ...
                    <div class="p-3 flex flex-col flex-1">
                        ...
                        <div class="mt-auto">
                            ...
                            <button
                                class="w-full h-9 rounded bg-surface-light dark:bg-[#1f351a] border border-primary text-primary hover:bg-primary hover:text-[#101b0d] text-sm font-bold flex items-center justify-center gap-2 transition-colors">
                                + Keranjang
                            </button>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div class="relative aspect-square overflow-hidden bg-gray-100">
                        <div class="w-full h-full bg-cover bg-center group-hover:scale-105 transition-transform duration-300"
                            data-alt="Red hot chili peppers"
                    ...
                    <div class="p-3 flex flex-col flex-1">
                        ...
                        <h3 class="font-bold text-sm text-[#101b0d] dark:text-white line-clamp-2 mb-2">Cabai Merah
                            Keriting (250g)</h3>
                        <div class="mt-auto">
                            <div class="flex items-baseline gap-2 mb-2">
                ...
                <!-- Product Card 5 -->
                <div
                    class="bg-surface-light dark:bg-surface-dark rounded-lg overflow-hidden border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow group flex flex-col hidden lg:flex">
                    <div class="relative aspect-square overflow-hidden bg-gray-100">
                        <div
                            class="absolute top-2 left-2 bg-red-500 text-white text-[10px] font-bold px-2 py-0.5 rounded">
                            -10%</div>
                        <div class="w-full h-full bg-cover bg-center group-hover:scale-105 transition-transform duration-300"
                            data-alt="Fresh spinach leaves"
                    ...
                    <div class="p-3 flex flex-col flex-1">
                        ...
                        <h3 class="font-bold text-sm text-[#101b0d] dark:text-white line-clamp-2 mb-2">Bayam Hijau
                            Segar Ikat Besar</h3>
                        <div class="mt-auto">
                            <div class="flex items-baseline gap-2 mb-2">
        ...
        <section class="px-4 md:px-10 lg:px-40 py-10">
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
                ...
                <div class="flex gap-2 overflow-x-auto pb-2 md:pb-0 scrollbar-hide">
                    <button
                        class="px-4 py-2 rounded-full bg-primary text-[#101b0d] text-sm font-bold whitespace-nowrap">Semua</button>
                    <button
                        class="px-4 py-2 rounded-full bg-[#e9f3e7] dark:bg-[#2a3f25] hover:bg-gray-200 dark:hover:bg-[#344e2e] text-sm font-medium whitespace-nowrap transition-colors">Sayuran</button>
                    <button
                        class="px-4 py-2 rounded-full bg-[#e9f3e7] dark:bg-[#2a3f25] hover:bg-gray-200 dark:hover:bg-[#344e2e] text-sm font-medium whitespace-nowrap transition-colors">Buah</button>
                    <button
                        class="px-4 py-2 rounded-full bg-[#e9f3e7] dark:bg-[#2a3f25] hover:bg-gray-200 dark:hover:bg-[#344e2e] text-sm font-medium whitespace-nowrap transition-colors">Bumbu
                        Dapur</button>
                </div>
            </div>
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-y-8 gap-x-4">
                ...
                <div class="group flex flex-col gap-2">
                    <div class="relative aspect-[4/3] rounded-lg overflow-hidden bg-gray-100">
                        <div class="w-full h-full bg-cover bg-center group-hover:scale-105 transition-transform duration-300"
                            data-alt="Purple eggplant"
                            style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuCSfkumhHbkdaheifVsyWMTvSJJILuo8_xZ_a4B_Dlmcnp0TKcC1U0u0gl-nVyHAACROx4Jm-F88EdktdgqMtBR9q17-ZpTXmT4GECk8evAlC_7ub1gXYcz2efVwqnXZV2Wxg5bUQsLB_TPIN1n4uwbv3zcOOyzAVUNqtquuBnxq9pA2xCgndXZDk-fUJXJmHLze9q9ZYnBIhmElGSLF3LCq3PynTIuBAOyruYtZqgasp2SmeB3YWL1VKooEt_VuwfyXLz3-2XOIwA");'>
                        </div>
                        <button
                            class="absolute bottom-2 right-2 size-8 bg-white dark:bg-[#101b0d] rounded-full flex items-center justify-center shadow-sm opacity-0 group-hover:opacity-100 transition-opacity">
                            <span class="material-symbols-outlined text-primary text-[20px]">add</span>
            ...
            <div class="mt-10 flex justify-center">
                <button
                    class="px-8 py-3 rounded-lg border-2 border-primary text-primary hover:bg-primary hover:text-[#101b0d] font-bold text-sm transition-colors">
        ...
        <div class="px-4 md:px-10 lg:px-40 py-10">
            <div
                class="bg-[#101b0d] rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
                <!-- Decorative circle -->
                ...
                <div class="flex flex-col gap-4 max-w-lg relative z-10">
                    <h2 class="text-white text-2xl md:text-3xl font-bold">Belanja Lebih Mudah dengan Aplikasi AgriMart
                    </h2>
                    <p class="text-gray-300 text-sm md:text-base">Dapatkan notifikasi promo eksklusif dan lacak
                        pesananmu secara real-time dari genggaman.</p>
                    <div class="flex gap-4 mt-2">
                        <button
                            class="h-10 px-4 bg-white/10 hover:bg-white/20 rounded-lg flex items-center gap-2 text-white text-xs font-bold border border-white/20 transition-colors">
                ...
                <div class="relative z-10 hidden md:block w-64 h-40 bg-contain bg-center bg-no-repeat"
                    data-alt="Mockup of a smartphone showing the AgriMart app"
    ...
    <footer class="bg-surface-light dark:bg-surface-dark border-t border-[#e9f3e7] dark:border-[#2a3f25] pt-12 pb-6">
        <div class="px-4 md:px-10 lg:px-40">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                        Platform e-commerce pertanian terpercaya yang menghubungkan petani lokal dengan konsumen untuk
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex gap-2">
                        <input
                            class="flex-1 bg-[#f0f5ee] dark:bg-[#1a2e16] border-none rounded-lg px-3 py-2 text-sm placeholder-gray-400 focus:ring-1 focus:ring-primary"
                            placeholder="Email Anda" type="email" />
                        <button
                            class="bg-primary hover:bg-[#32d611] text-[#101b0d] rounded-lg px-4 py-2 text-sm font-bold transition-colors">
                            Kirim
                        </button>
                    </div>
                </div>
            ...
            <div
                class="pt-8 border-t border-[#e9f3e7] dark:border-[#2a3f25] flex flex-col md:flex-row items-center justify-between gap-4">
